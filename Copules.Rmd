...
plot(engie.ret,total.ret, xlim=c(-5,5), ylim=c(-5,5),col=c("blue","red"))
...
persp(x=xc, y=yc, z=zc, theta=-30, phi=30, expand=0.7, shade=0.5, main = "Copule ENGIE/TOTAL", col="green")
